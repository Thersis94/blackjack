 ...
 * <b>Description: </b> Hand class is a class for holding a collection of cards that belong to a player instance
...
public class Hand {
	...
	public int handValue() {
		...
		//While the ace count is greater than 0 and the currentHandValue plus 10 is less than or equal to 21
