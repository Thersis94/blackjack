...
/****************************************************************************
 * <b>Title</b>: Deck.java <b>Project</b>: blackjack <b>Description: </b> Deck
 * class that will hold and handle methods for the creation and transfer of card
 * objects <b>Copyright:</b> Copyright (c) 2020 <b>Company:</b> Silicon Mountain
 * Technologies
 * 
...
public class DeckVO {
	...
	private ArrayList<CardVO> deck = new ArrayList<CardVO>();// ArrayList for storing ever Card object
	...
	public CardVO dealCard() {
		...
		CardVO dealtCard = deck.get(0);// Store the top Card from the deck
		...
		for (int c = 0; c < 52; c++) {
			...
			for (int s = 0; s < suits.length; s++) {
				...
				for (int l = 0; l < labels.length; l++) {
					CardVO card = new CardVO();// Create new Card instance
	 ...
	 */
	public void addCardToDeck(CardVO cardToAdd) {
		deck.add(cardToAdd);
	}
}
