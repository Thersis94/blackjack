...
/****************************************************************************
 * <b>Title</b>: UserInterface.java
 * <b>Project</b>: blackjack
 * <b>Description: </b> The UserInterface class is used to display text and receive input from a user.
...
public class UserInterface {
	 ...
	 * 
	 * @param message This param contains a String the will be displayed to the user
	 * @param userInputRequest This param determines whether or not to run the collectUserInput method
	 * @return If userInputRequest is true this will return the values entered by the user
	 */
